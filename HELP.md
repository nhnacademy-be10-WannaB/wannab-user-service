...
* [Spring Data Reactive Redis](https://docs.spring.io/spring-boot/3.3.12/reference/data/nosql.html#data.nosql.redis)
...
```
$ docker run --rm -p 8080:8080 userservice:0.0.1-SNAPSHOT
```
